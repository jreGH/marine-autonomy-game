...
MOOS_CXX_FLAGS="-Wall -Wextra -Wno-unused-parameter -Wno-cast-function-type -Wno-error=cast-function-type -pedantic -fPIC"
...
if [ "${BUILD_BOT_CODE_ONLY}" = "OFF" ] ; then
	...
	echo "Invoking cmake..." `pwd`
	cmake -Wno-dev -DBUILD_CONSOLE_TOOLS=ON                  \

...
BHV=("points=format=bowtie,x=319.87,y=-189.61,height=177,wid1=44.25,wid2=141.6,wid3=177,label=Spotted-belly_catshark_bwt" "points=zigzag:-706.96,808.12,-90,2228,481,51" "points=format=bowtie,x=-856.62,y=-517.86,height=52,wid1=13.0,wid2=41.6,wid3=52,label=Longnose_houndshark_bwt" "points=zigzag:172.01,835.33,-165,2029,289,120")

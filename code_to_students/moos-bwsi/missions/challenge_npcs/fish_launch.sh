...
START_POS=("x=-416.0,y=-436.0,speed=0,depth=5,heading=181" "x=1484.0,y=525.0,speed=0,depth=5,heading=355" "x=314.0,y=-1254.0,speed=0,depth=5,heading=306" "x=-434.0,y=1067.0,speed=0,depth=5,heading=276" "x=119.0,y=1269.0,speed=0,depth=5,heading=318" "x=1293.0,y=453.0,speed=0,depth=5,heading=335" "x=396.0,y=-792.0,speed=0,depth=5,heading=236" "x=-782.0,y=1205.0,speed=0,depth=5,heading=181" "x=-1253.0,y=-948.0,speed=0,depth=5,heading=241" "x=446.0,y=-964.0,speed=0,depth=5,heading=212" "x=880.0,y=-697.0,speed=0,depth=5,heading=6" "x=-684.0,y=-980.0,speed=0,depth=5,heading=49")

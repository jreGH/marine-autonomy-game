...
TYPES=("kayak" "kayak" "kayak" "kayak")
AUV_PORTS=("9001" "9002" "9003" "9004")
AUV_PSHARE=("9201" "9202" "9203" "9204")
START_POS=("x=-21.09,y=-194.34,speed=0,heading=0,depth=0" "x=-166.57,y=31.80,speed=0,heading=0,depth=0" "x=-91.37,y=75.95,speed=0,heading=0,depth=0" "x=37.28,y=-198.00,speed=0,heading=0,depth=0")
LOITER_POS=("x=-250.00,y=250.00" "x=-195.00,y=250.00" "x=-140.00,y=250.00" "x=-85.00,y=250.00")

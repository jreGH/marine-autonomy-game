...
V0="Nuestra_Senora_de_las_Mercedes"
V1="Titanic"

HOSTIP=`hostname -I | awk '{print $3}'`
SHOREIP=$HOSTIP
VEHICLES=($V0 $V1)
TYPES=("treasure" "treasure")
AUV_PORTS=(9322 9323)
AUV_PSHARE=(9422 9423)
START_POS=("x=1325.0,y=1383.0,speed=0,depth=500,heading=59" "x=747.0,y=-1029.0,speed=0,depth=500,heading=97")

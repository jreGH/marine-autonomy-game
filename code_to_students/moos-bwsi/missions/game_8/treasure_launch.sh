...
V0="Titanic"
V1="Queen_Annes_Revenge"
V2="Nuestra_Senora_de_las_Mercedes"

HOSTIP=`hostname -I | awk '{print $3}'`
SHOREIP=$HOSTIP
VEHICLES=($V0 $V1 $V2)
TYPES=("treasure" "treasure" "treasure")
AUV_PORTS=(9320 9321 9322)
AUV_PSHARE=(9420 9421 9422)
START_POS=("x=607.0,y=702.0,speed=0,depth=500,heading=91" "x=-130.0,y=913.0,speed=0,depth=500,heading=6" "x=145.0,y=-1368.0,speed=0,depth=500,heading=118")

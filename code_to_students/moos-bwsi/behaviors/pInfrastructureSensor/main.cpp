...
int main(int argc, char* argv[])
{
    ...
    cout << "pInfrastructureSensor launching as " << run_command << endl;
    cout << termColor() << endl;

    InfrastructureSensor sensor;
    sensor.Run(run_command.c_str(), mission_file.c_str());
